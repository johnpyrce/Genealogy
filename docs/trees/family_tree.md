...
```text
Tree 1
└── Family 1 · main line · sources: S2
    ├── Partner 1: Person 1 · Wawrzyniec Gościński (1760)
    ├── Partner 2: Person 2 · Teresa Bartmanowicz
    ...
    └── Children:
        ├── Person 3 · Wawrzyniec Gościński (1780)
        │   └── Family 2 · main line · sources: S2
        │       ├── Partner 1: Person 3 · Wawrzyniec Gościński (1780) · ↪ child in Family 1
...
└── Family 24 · main line · sources: S3
    ...
    └── Children:
        ├── Person 78 · Józef Pyrc (1879–1940)
        │   └── ↪ Family 25 (expanded elsewhere)
        ├── Person 85 · Maria Pyrc
        │   └── Family 26 · main line · sources: S3
        │       ├── Partner 1: Person 85 · Maria Pyrc · ↪ child in Family 24
        │       ├── Partner 2: Person 86 · Jan Storoż
...
└── Family 44 · spouse ancestry · sources: S2
    ...
    └── Children:
        └── Person 132 · Piotr Miczulski (1805)
            └── Family 45 · spouse ancestry · sources: S2
                ├── Partner 1: Person 132 · Piotr Miczulski (1805) · ↪ child in Family 44
                ├── Partner 2: Person 133 · Marianna Sajdak
                ├── Registry note: S2 Miczulski spouse pedigree.
                └── Children:
                    └── Person 135 · Jan Miczulski (1833)
                        └── Family 55 · spouse ancestry · sources: S2
                            ├── Partner 1: Person 135 · Jan Miczulski (1833) · ↪ child in Family 45
...
└── Family 46 · spouse ancestry · sources: S2
    ...
    └── Children:
        └── Person 146 · Maria Moszczak (1903–1993)
            └── Family 50 · spouse ancestry · sources: S2
                ├── Partner 1: Person 145 · Franciszek Śliwa (1905–1981) · ↪ child in Family 49
                ├── Partner 2: Person 146 · Maria Moszczak (1903–1993) · ↪ child in Family 46
...
└── Family 51 · spouse ancestry · sources: S2
    ...
    └── Children:
        └── Person 149 · Franciszek Szost (1832)
            └── Family 53 · spouse ancestry · sources: S2
                ├── Partner 1: Person 149 · Franciszek Szost (1832) · ↪ child in Family 51
                ├── Partner 2: Person 150 · Zofia Wilczyńska
...
└── Family 56 · spouse ancestry · sources: S2, S5
    ...
    └── Children:
        └── Person 94 · Joanna Gruczelak (1901–1994)
            └── Family 29 · main line · sources: S5, S2
                ...
                └── Children:
                    ...
                    └── Person 128 · Henryk Rams (1927–2024)
...
└── Family 57 · collateral · sources: S5
    ...
    └── Children:
        ...
        │           │   │   ├── Partner 1: Person 123 · Michał Rams (1910–1974) · ↪ also partner in Family 41 · ↪ child in Family 27
        │           │   │   ├── Partner 2: Person 124 · Katarzyna
        │           │   │   ├── Registry note: Wife placement is uncertain.
        │           │   │   └── Children: none recorded
        │           │   └── Family 41 · collateral · sources: S5
        │           │       ├── Partner 1: Person 123 · Michał Rams (1910–1974) · ↪ also partner in Family 40 · ↪ child in Family 27
        │           │       ├── Partner 2: Person 125 · Janina Fedorczak
        │           │       ├── Registry note: Second wife shown; placement is uncertain.
        │           │       └── Children: none recorded
        │           └── Person 126 · Stanisława Rams (1923–2013)
        ...
        │       ├── Partner 1: Person 90 · Wawrzyniec Rams · ↪ child in Family 57
        │       ├── Partner 2: Person 91 · Agata
...
└── Family 63 · spouse ancestry · sources: S5
    ...
    └── Children:
        └── Person 15 · Marianna Miczulska (1895–1962) · ↪ also child in Family 55
            └── ↪ Family 8 (expanded elsewhere)
